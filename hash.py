...
class MD5(object):
    ...
    @classmethod
    def hashhash(cls, string):
        cls._string = string
        print("string defined as " + str(cls._string))
        print("buffers defined as " + str(cls._buffers))
    ...
    def _step_5(cls):
        ...
        bit_array = bitarray(endian="big")
        bit_array.fromstring(A.decode("utf-8"))
        print("A = " + str(bit_array))
